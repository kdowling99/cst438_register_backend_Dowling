...
public class JunitTestStudent {
	...
	public static final String TEST_STUDENT_EMAIL = "test3@csumb.edu";
	...
	public void testAddStudent()  throws Exception {
	    ...
	    given(studentRepository.findByEmail(TEST_STUDENT_EMAIL)).willReturn(null);  //I CHANGED THIS
